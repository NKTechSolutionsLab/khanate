...
const networkNodes = [

  {
    ...
    position: "top-[8%] left-[3%] lg:left-[8%]",

    line: "top-[22%] left-[20%] w-[23%] rotate-[14deg]",
...

  {
    ...
    position: "top-[2%] right-[3%] lg:right-[8%]",

    line: "top-[17%] right-[20%] w-[22%] -rotate-[12deg]",
...

  {
    ...
    position: "bottom-[5%] left-[7%] lg:left-[14%]",

    line: "bottom-[23%] left-[25%] w-[22%] -rotate-[14deg]",
...

  {
    ...
    position: "bottom-[4%] right-[4%] lg:right-[11%]",

    line: "bottom-[20%] right-[22%] w-[22%] rotate-[13deg]",
...
if (historySection && historyProgress && historyItems.length) {
  ...
  historyItems.forEach((item) => {
    const circleFill = item.querySelector(".be-history-circle-fill");
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-360 px-6 pb-16 pt-28 sm:px-8 lg:px-12 lg:pb-20 lg:pt-36">
          ...
          <div className="be-reveal flex items-center justify-between border-b border-[#F5EEE7]/10 pb-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-[0.23em] text-[#B79A69]">
            ...
            <span className="hidden text-[11px] uppercase tracking-[0.2em] text-[#F5EEE7]/35 sm:block">
          ...
          <div className="grid gap-12 py-14 lg:grid-cols-[0.82fr_1.18fr] lg:gap-8 lg:py-20">
            ...
            <div className="be-reveal relative z-10 lg:pt-10">
              ...
              <p className="max-w-32 text-[11px] font-semibold uppercase leading-[1.7] tracking-[0.2em] text-[#B79A69]">
              ...
              <div className="mt-10 flex items-center gap-5">
                ...
                <span className="text-[11px] uppercase tracking-[0.18em] text-[#F5EEE7]/28">
            ...
            <div className="be-network relative min-h-[460px] lg:min-h-[560px]">
              ...
              <div className="absolute left-1/2 top-1/2 h-60 w-60 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#B79A69]/30 sm:h-80 sm:w-80">

                <div className="absolute inset-7 rounded-full border border-[#B79A69]/20" />



                <div className="absolute inset-[22%] rounded-full bg-[#5A101C]/80 shadow-[0_0_100px_rgba(183,154,105,0.08)]" />



                <div className="absolute left-1/2 top-1/2 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-full border border-[#B79A69] bg-[#130207] text-center sm:h-36 sm:w-36">
              ...
              <div className="absolute left-1/2 top-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-dashed border-[#B79A69]/20 sm:h-[460px] sm:w-[460px]" />
              ...
              {networkNodes.map((node) => (
                ...
                <div
                  ...
                  className={`pointer-events-none be-network-line absolute hidden h-px bg-[#B79A69]/45 lg:block ${node.line}`}
              ...
              {networkNodes.map((node) => (
                ...
                <div
                  ...
                  className={`be-network-node absolute ${node.position}`}
                ...
                >
                  ...
                  <div className="flex max-w-34 items-center gap-3">
                    ...
                    <span className="text-[11px] font-semibold uppercase leading-[1.5] tracking-[0.14em] text-[#F5EEE7]/70">
              ...
              <div className="absolute bottom-0 left-0 right-0 border-t border-[#F5EEE7]/10 pt-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="h-px mx-5 flex-1 bg-[#F5EEE7]/10" />
      ...
      <section className="border-b border-[#191113]/10 bg-[#D9CCC1]">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              ...
              <div
                ...
                className={`be-reveal group border-[#191113]/10 py-7 sm:px-6 lg:px-7 ${index % 2 === 0
      ...
      <section className="bg-[#F0E7DE]">
        ...
        <div className="mx-auto max-w-360 px-6 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
          ...
          <div className="be-reveal relative max-w-250">
            ...
            <p className="pl-7 font-serif text-[2.5rem] leading-[1.05] tracking-[-0.02em] text-[#191113] sm:text-[3.6rem] lg:text-[4.5rem]">
              ...
              <span className="text-[#A06A52]">
                ...
                the right opportunity often begins with the right relationship.
          ...
          <div className="mt-16 grid gap-8 border-t border-[#191113]/12 pt-8 sm:grid-cols-3">
            ...
            <div className="be-reveal">
              ...
              <p className="mt-4 text-[16px] leading-[1.75] text-[#191113]/56">

                European businesses seeking access to international
            ...
            <div className="be-reveal">
              ...
              <p className="mt-4 text-[16px] leading-[1.75] text-[#191113]/56">
                ...
                Investors and family offices looking toward relevant
            ...
            <div className="be-reveal">
              ...
              <p className="mt-4 text-[16px] leading-[1.75] text-[#191113]/56">
                ...
                Entrepreneurs and businesses seeking strategic partners
        ...
        <div className="mx-auto max-w-360 px-6 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
          ...
          <div className="flex flex-col justify-between gap-10 border-b border-[#F5EEE7]/10 pb-12 lg:flex-row lg:items-end">
            ...
            <div className="be-reveal">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#B79A69]">
          ...
          <div className="mt-12">
            ...
            {focusAreas.map((item) => (
              ...
              <article
                ...
                className="be-focus-row group grid gap-5 border-b border-[#F5EEE7]/10 py-8 sm:grid-cols-[70px_270px_1fr] sm:items-center"
              ...
              >
                ...
                <div className="flex items-center gap-5">
                  ...
                  <p className="max-w-130 text-[16px] leading-[1.7] text-[#F5EEE7]/48">
      ...
      ========================================== */}
            ...
            <div className="be-reveal lg:sticky lg:top-32 lg:h-fit">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#A06A52]">
                THE HISTORY
              </span>
              ...
              <p className="mt-7 max-w-75 text-[13px] leading-[1.75] text-[#191113]/45">
          ...
          ========================================== */}
                ...
                <article className="be-history-item relative pl-10 sm:pl-14">
                  ...
                  <div className="absolute left-0 top-1 flex h-6 w-6 items-center justify-center rounded-full border border-[#A06A52] bg-[#E9DED4]">
                    ...
                    <div className="be-history-circle-fill h-full w-full scale-0 rounded-full bg-[#A06A52]" />
                  ...
                  <div className="be-history-card">
                    ...
                    <div className="be-history-meta">
                      ...
                      <span className="mt-2 block text-[10px] uppercase tracking-[0.18em] text-[#191113]/30">
                        01 / ORIGIN
                      </span>
                    ...
                    <p className="mt-5 max-w-125 text-[16px] leading-[1.75] text-[#191113]/55">
                    ...
                    <div className="mt-7 border-t border-[#191113]/10 pt-4">
                      ...
                      <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#A06A52]">
                        FOUNDATION
                      </span>
                ...
                <article className="be-history-item relative pl-10 sm:pl-14">
                  ...
                  <div className="be-history-card">
                    ...
                    <p className="mt-5 max-w-125 text-[16px] leading-[1.75] text-[#191113]/55">
                      ...
                      international capital and strategic relationships.
                    </p>
      ...
      <section className="be-final relative overflow-hidden bg-[#5A101C] text-[#F5EEE7]">
        ...
        <div className="mx-auto max-w-360 px-6 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-32">
          ...
          <div className="grid items-end gap-14 lg:grid-cols-[1fr_auto]">
            ...
            <div className="be-reveal">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#D8BF8E]">
            ...
            <div className="be-final-mark relative flex h-36 w-36 items-center justify-center rounded-full border border-[#D8BF8E]/50 lg:h-44 lg:w-44">
              ...
              <div className="text-center">
                ...
                <span className="block text-[11px] uppercase tracking-[0.18em] text-[#D8BF8E]">
          ...
          <div className="mt-16 flex flex-col justify-between gap-8 border-t border-[#F5EEE7]/12 pt-6 sm:flex-row sm:items-end">
            ...
            <div>
              ...
              <p className="max-w-105 text-[16px] leading-[1.75] text-[#F5EEE7]/48">
