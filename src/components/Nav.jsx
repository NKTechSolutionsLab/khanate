...
function Nav({ animate }) {
  ...
  className="nav-logo relative z-60 flex h-[4.05rem] w-[13.35rem] translate-y-3.5 items-center overflow-hidden opacity-0"
>
  <img
    src={logo}
    alt="KHĀNATE"
  ...
  />
        ...
        <div className="hidden items-center lg:flex">
          ...
          <a
            href="#private-access"
            className="nav-access group ml-7 flex h-11 w-45 translate-y-3.5 items-center justify-between border border-[#B79A69]/70 bg-[#5A101C]/85 px-5 text-[9.6px] font-semibold uppercase tracking-[0.16em] text-[#F5EEE7] opacity-0 transition-all duration-300 hover:border-[#B79A69] hover:bg-[#B79A69] hover:text-[#191113] xl:ml-8 xl:h-11.5 xl:w-47 xl:text-[10.8px]"
          >
            <span>PRIVATE ACCESS</span>

            <span className="text-[19.2px] font-light leading-none transition-transform duration-300 group-hover:translate-x-1">
              →
            </span>
          </a>
        </div>
        ...
        <div className="flex min-h-screen flex-col px-6 pb-6 pt-28 sm:px-10">
          ...
          <div className="flex flex-col">
            {navItems.map((item, index) => (
              ...
              >
                <span className="text-[8.4px] tracking-[0.12em] text-[#B79A69]">
                  0{index + 1}
                </span>
                ...
                <span className="text-[19.2px] font-light transition-transform duration-300 group-hover:translate-x-1">
                  →
                </span>
              </a>
            ))}
          ...
          <a
            href="#private-access"
            onClick={closeMenu}
            className="mt-7 flex h-12 items-center justify-between border border-[#B79A69]/70 bg-[#5A101C] px-5 text-[9.6px] font-semibold uppercase tracking-[0.17em] text-[#F5EEE7] transition-all duration-300 hover:bg-[#B79A69] hover:text-[#191113]"
          >
            <span>PRIVATE ACCESS</span>

            <span className="text-[19.2px] font-light">
              →
            </span>
          </a>

          <div className="mt-auto border-t border-[#B79A69]/25 pt-5">
            <div className="flex items-center justify-between text-[8.4px] uppercase tracking-[0.17em] text-[#817173]">
