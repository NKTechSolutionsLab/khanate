...
function Hero({ animate }) {
  ...
  useLayoutEffect(() => {
    ...
    const desktopStatement = hero.querySelector(".hero-statement-desktop");
    const mobileStatement = hero.querySelector(".hero-statement-mobile");
  ...
  return (
    ...
    >
      ...
      <div className="hero-background absolute inset-0 scale-[1.035] opacity-0">
        <picture>
          <source media="(max-width: 640px)" srcSet={heroBgSm} />
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="w-full max-w-162.5">
            ...
            <h1
              ...
              "
            >
              <span className="block">PRIVATE CAPITAL.</span>

              <span className="block">STRATEGIC ACCESS.</span>

              <span className="block text-[#D8BF8E]">EUROPEAN</span>

              <span className="block text-[#D8BF8E]">OPPORTUNITIES.</span>
            </h1>
